-- ============================================
-- SYSTÈME DE DEVIS COMPLET (Version Safe)
-- ============================================

-- PARTIE 1: Drop existing tables if needed
-- ============================================
...
DO $$
BEGIN
  -- Add prestataire_id foreign key if prestataires table exists
  ...
  -- Add client_id foreign key if clients table exists
  ...
  -- Add demande_id foreign key if demandes table exists
...
BEGIN
  ...
  RAISE NOTICE '2. Foreign keys ajoutées';
  RAISE NOTICE '3. Fonction de génération de numéro créée';
  RAISE NOTICE '4. Triggers de calcul automatique créés';
  RAISE NOTICE '5. RLS policies configurées';
  RAISE NOTICE '6. Prêt à utiliser!';
END $$;
